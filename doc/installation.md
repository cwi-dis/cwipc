...
(https://github.com/cwi-dis/cwipc/releases/latest) and execute it.  If the
...
*See also:* the README sections on environment variables, camera setup, and
> [raw recording](raw-recording.md).