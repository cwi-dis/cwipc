macro(get_git_version)
	# Fallback version. Update on major 
	set(CWIPC_VERSION_UNKNOWN "8.0+unknown")
	set(options)
	...
	if(status AND NOT status EQUAL 0)
		...
		set(describe_version ${CWIPC_VERSION_UNKNOWN})
		if(IS_READABLE "${CMAKE_SOURCE_DIR}/.cachedgitversion.txt")
			file(READ "${CMAKE_SOURCE_DIR}/.cachedgitversion.txt" describe_version)
		elseif(IS_READABLE "${CMAKE_SOURCE_DIR}/.sourceversion.txt")
			file(READ "${CMAKE_SOURCE_DIR}/.sourceversion.txt" describe_version)
		endif()
